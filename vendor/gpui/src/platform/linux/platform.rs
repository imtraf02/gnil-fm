...
pub(crate) struct LinuxCommon {
    ...
    pub(crate) quit_when_last_window_closed: bool,
...
impl LinuxCommon {
    pub fn new(signal: LoopSignal) -> (Self, Channel<Runnable>) {
        ...
        let common = LinuxCommon {
            ...
            callbacks,
            signal,
            quit_when_last_window_closed: true,
            menus: Vec::new(),
        };
...
impl<P: LinuxClient + 'static> Platform for P {
    ...
    fn set_quit_when_last_window_closed(&self, quit: bool) {
        self.with_common(|common| common.quit_when_last_window_closed = quit);
    }
