...
use crate::{
    ...
    DEFAULT_WINDOW_SIZE, DevicePixels, DispatchEventResult, ExternalFileDragMode, ExternalPaths,
    Font, FontId, FontMetrics, FontRun, ForegroundExecutor, GlyphId, GpuSpecs, ImageSource, Keymap,
...
pub(crate) trait Platform: 'static {
    ...
    fn quit(&self);
    fn set_quit_when_last_window_closed(&self, _quit: bool) {}
...
pub(crate) trait PlatformWindow: HasWindowHandle + HasDisplayHandle {
    ...
    fn start_external_file_drag(&self, _paths: ExternalPaths, _mode: ExternalFileDragMode) -> bool {
        false
    }
...
pub struct WindowOptions {
    ...
    /// A parent owned by another process. Wayland parents are imported with xdg-foreign v2.
    pub external_parent: Option<ExternalWindowParent>,
...
/// Identifies a parent window owned by another process.
#[derive(Clone, Debug, Eq, PartialEq)]
pub enum ExternalWindowParent {
    /// An xdg-foreign v2 exported surface handle.
    Wayland(String),
}
