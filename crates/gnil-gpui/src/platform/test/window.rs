use crate::{
    ...
    ExternalFileDragError, ExternalPaths, GpuSpecs, Pixels, PlatformAtlas, PlatformDisplay,
...
pub(crate) struct TestWindowState {
    ...
    is_fullscreen: bool,
    pub(crate) external_file_drag: Option<ExternalPaths>,
}
...
impl PlatformWindow for TestWindow {
    ...
    fn start_external_file_drag(
        ...
        self.0.lock().external_file_drag = Some(paths);
        Ok(())
    }
