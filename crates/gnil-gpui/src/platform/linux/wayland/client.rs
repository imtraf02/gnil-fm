...
use wayland_protocols::xdg::foreign::zv2::client::{zxdg_imported_v2, zxdg_importer_v2};
...
use crate::{
    ...
    ExternalFileDragError, ExternalPaths, FileDropEvent, ForegroundExecutor, KeyDownEvent,
    KeyUpEvent, Keystroke, LinuxCommon, LinuxKeyboardLayout, Modifiers, ModifiersChangedEvent,
    MouseButton, MouseDownEvent, MouseExitEvent, MouseMoveEvent, MouseUpEvent, NavigationDirection,
    Pixels, PlatformDisplay, PlatformInput, PlatformKeyboardLayout, Point, SCROLL_LINES,
...
pub struct Globals {
    ...
    pub foreign_importer: Option<zxdg_importer_v2::ZxdgImporterV2>,
...
impl Globals {
    fn new(
        ...
        Globals {
            ...
            foreign_importer: globals.bind(&qh, 1..=1, ()).ok(),
...
impl WaylandClientStatePtr {
    ...
    pub fn start_external_file_drag(
        ...
        let (Some(data_device_manager), Some(data_device)) = (
            ...
            return Err(ExternalFileDragError::Unavailable);
        };
    ...
    pub fn drop_window(&self, surface_id: &ObjectId) {
        ...
        if state.windows.is_empty()
            && state.common.quit_policy == crate::QuitPolicy::LastWindowClosed
        {
...
delegate_noop!(WaylandClientStatePtr: ignore zxdg_importer_v2::ZxdgImporterV2);
delegate_noop!(WaylandClientStatePtr: ignore zxdg_imported_v2::ZxdgImportedV2);
        ...
        match event {
            ...
            wl_data_source::Event::Cancelled | wl_data_source::Event::DndFinished => {
                ...
                if let Some(origin_window) = origin_window {
                    origin_window.handle_input(PlatformInput::FileDragEnded);
                }
            }
            _ => {}
        }
